...
This is done outside of Rstudio on Windows or Mac interface. Download the heartatk4R.txt file from [here](https://raw.githubusercontent.com/gexijin/learnR/master/datasets/heartatk4R.txt). It is a tab-delimited text file, meaning the different columns are separated by tab. We also need to get some context about the data and how it is collected. At the minimum level, we need to know the meaning of each columns.
...
You can even use the scan() function, and then copy and paste a column of numbers from Excel.
