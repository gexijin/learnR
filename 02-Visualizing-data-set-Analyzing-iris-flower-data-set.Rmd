...
```{exercise}
Generate the bubble plot Figure \@ref(fig:9-5) based on the code:"plot(wt, mpg, pch = 16, cex = hp / 50, col = rainbow(8)[cyl])". Submit your complete code and the generated plot. Give a brief interpretation about your plot.
```
...
legend("topright",levels(as.factor(mtcars$cyl)),
