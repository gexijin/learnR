...
p <- ggplot(game, aes(x = Platform.type)) + geom_bar(fill = "blue")
p
```
...
(ref:game-PlatformType1) Sec Bar plot of platform type

```{r game-PlatformType1,  fig.cap='(ref:game-PlatformType1)', fig.align='center'}
q <- ggplot(game, aes(x = Platform.type)) + geom_bar(fill = "blue")
q
```
