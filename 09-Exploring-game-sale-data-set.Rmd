...
(ref:game-SalesYear1) Total sales by year

```{r game-SalesYear1, fig.width=8, fig.height=4, fig.cap='(ref:game-SalesYear1)', fig.align='center'}
...
(ref:game-SalesRegion1) Total sales by region
...
```{r game-SalesPlatform1, fig.cap='(ref:game-SalesPlatform1)', fig.align='center'}
library(viridis)
library(scales)
p <- game %>%
