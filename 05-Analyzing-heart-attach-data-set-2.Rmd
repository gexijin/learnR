...
```{exercise}
Use multiple linear regression to investigate the factors associated with length of stay. Obvious we need to exclude charges in our model. Interpret your results.
```

This is not part of the exercise, but another problem we could look into is who are more likely to have complications. We should only focusing on the surviving patients and do logistic regression. 
