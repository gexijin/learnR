...
Even back in the early days, California and New York were the hot-spots, while South Dakota was more of a quiet retreat.
...
sta.income <- sta %>% 
  mutate(IncomeType = factor(ifelse(Income < 3500, "Under3500",  
