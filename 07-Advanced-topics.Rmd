...
Let's start learning R Markdown from its cheat sheet. Click the RStudio IDE under *Help $\rightarrow$ Cheatsheets $\rightarrow$ R Markdown Cheat Sheet.* 

\begin{center} 
\includegraphics[width=8in]{rmarkdownCheatSheet.pdf}
\end{center}

```{r label, include=F, out.width = "85%", fig.cap = "RMarkdown Cheet Sheet"}
